...
VALUES ('ROLE_SA', 'view all submissions'),
...
INSERT INTO public.judge_database (database_url, valid, keyword)
VALUES ('jdbc:postgresql://47.102.221.90:12002/postgres?allowMultiQueries=true&currentSchema=public&reWriteBatchedInserts=true
', true, 'k1');
INSERT INTO public.judge_database (database_url, valid, keyword)
VALUES (
...
VALUES (2, 'p2.1', 'd2.1', 20, 256, 3000, 0, 0, 1, 'no solution', 'select'),
       (2, 'p2.2', 'd2.2', 20, 256, 3000, 0, 0, 2, 'no solution', 'select'),
       (2, 'p2.3', 'd2.3', 20, 256, 3000, 0, 0, 3, 'no solution', 'select'),
       (2, 'p2.4', 'd2.4', 20, 256, 3000, 0, 0, 4, 'no solution', 'select'),
       (2, 'p2.5', 'd2.5', 20, 256, 3000, 0, 0, 5, 'no solution', 'select');
