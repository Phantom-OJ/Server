...
class JudgeServiceTest {
    ...
    judgeSelect() throws SQLException, InterruptedException, IOException {
        CodeForm codeForm=new CodeForm();
        codeForm.setCode(ACanswer);
        codeForm.setDialect("mysql");
        ...
        judgeService.judgeCode(1,codeForm,1);
        codeForm.setCode(ACanswer);
        codeForm.setDialect("sqlite");
        codeForm.setSubmitTime(12345L);
        judgeService.judgeCode(1,codeForm,1);
    }
    @Test
    public void judgeTrigger() throws SQLException, InterruptedException, IOException {
        CodeForm codeForm=new CodeForm();
